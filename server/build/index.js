...
var serialInterface_1 = require("./lib/serialInterface");
...
server.on("listening", function () {
    ...
    var serial = serialInterface_1.listen({
        onOpen: function () {
        ...
        onData: function (data) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        logger.trace(data);
                        if (!(data.indexOf("NMBR=") > -1)) return [3 /*break*/, 2];
                        phoneNumber = data.split("=").pop();
                        return [4 /*yield*/, lookupNumber_1.default(phoneNumber)];
                    case 1:
                        _a.sent();
                        _a.label = 2;
